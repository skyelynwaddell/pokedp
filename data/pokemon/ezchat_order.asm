...
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, BIBAREL, PSYDUCK, PHANPY, LUXRAY, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.hi_bi_pi: db CLEFFA, BIDOOF, PIKACHU, CLEFABLE, LUXIO, SHINX, PICHU, CLEFAIRY, CHIMCHAR, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
