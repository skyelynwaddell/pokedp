...
MonMenuIcons:
	...
	db ICON_CHARMANDER  ; CHIMCHAR
	db ICON_CHARMANDER  ; MONFERNO
	db ICON_BIGMON      ; INFERNAPE
	db ICON_SQUIRTLE    ; PIPLUP
	db ICON_SQUIRTLE    ; PRINPLUP
	db ICON_SQUIRTLE    ; EMPOLEON
	db ICON_CATERPILLAR ; STARLY
	db ICON_CATERPILLAR ; STARAVIA
	db ICON_MOTH        ; STARAPTOR
	db ICON_CATERPILLAR ; BIDOOF
