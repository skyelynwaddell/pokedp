...
BugsyGroup:
	...
	db 14, STARAVIA,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, BIBAREL,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
ChampionGroup:
	...
	db 46, INFERNAPE,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
CooltrainerMGroup:
	...
	db 26, CHIMCHAR, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 26, PIPLUP,   WITHDRAW, WATER_GUN, BITE, CURSE
	...
	db 27, MONFERNO, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, EMPOLEON,   BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 25, STARAPTOR, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
BugCatcherGroup:
	...
	db 24, STARAPTOR, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, STARAPTOR, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, KRICKETOT,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, STARAPTOR, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, STARAPTOR, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, STARAPTOR, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, KRICKETOT,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 34, STARAPTOR, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
RedGroup:
	...
	db 77, INFERNAPE,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, EMPOLEON,   RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
