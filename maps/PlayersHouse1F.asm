...
MeetMomScript:
	;test debug mom script
	refreshscreen
	pokepic EMPOLEON
	waitbutton
	closepokepic
	opentext
	givepoke SHINX, 100, BERRY
	givepoke LUXIO, 100, BERRY
	givepoke LUXRAY, 100, BERRY
	givepoke STARLY, 100, BERRY
	givepoke STARAVIA, 100, BERRY
	givepoke STARAPTOR, 100, BERRY
	closetext
	giveitem POCKET_PC
